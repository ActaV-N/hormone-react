...
const NoradrenalineContainer = styled.div`

`

const Noradrenaline = () => {
    return <NoradrenalineContainer>
        <Info>
            <Info.Head>The happy hormone</Info.Head>
            <Info.Image src='images/noradrenaline/noradrenaline-1.jpg' alt='noradrenaline' small />
            <Info.GridContainer>
                <Info.GridItem>
                ...
                <Info.GridItem>
                    <Info.GridItemTitle>The happy hormone, Noradrenaline</Info.GridItemTitle>
                    <Info.GridItemBody>
                ...
                <Info.GridItem>
                    <Info.GridItemTitle>How to secrete Noradrenaline</Info.GridItemTitle>
                    <Info.GridItemBody>
    ...
    </NoradrenalineContainer>
}

export default Noradrenaline